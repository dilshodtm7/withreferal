...
const Home = ({ data,myId,userData,loading, fetchAccountData,tournament }) => {
  const updateStatusWithBanalce = "https://withreferal-back-b83k.onrender.com/auth/bybalance";
  const updateStatus = "https://withreferal-back-b83k.onrender.com/auth/updatestatus";
