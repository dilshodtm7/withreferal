...
const Settings = ({ data, loading, myId, fetchAccountData }) => {
  ...
  const newspin = "https://withreferal-back-b83k.onrender.comauth/newspin";
  const newquestion = "https://withreferal-back-b83k.onrender.com/auth/question";
      ...
      {!loading ? (
        ...
        <>
          ...
          <div className="daily-question">
            ...
            <button className="crossword-btn-enter" id="question-btn" onClick={checkAnswer} >Loading</button>
          ...
          <div className="setting-container">
            ...
            <button className="spin-btn" id="spin-btn" onClick={handleSpinClick} >Loading</button>
          </div>
        </>
      )}
    </>
