        ...
        <div className="invite">
          ...
          <div className="invite-link">
            ...
            <div className="invite-buttons">
              <a href={`https://t.me/share/url?url=https://t.me/winniecoin_bot/play?startapp=${encodeURIComponent(data.user_tg)}&text=${encodeURIComponent('💎 Get a WINNIE COIN airdrop!%0A%0A💸 +5000 WINNIE COIN and +1 TON as a first-time gift!%0A%0AJoin now and start mining!')}`}>
